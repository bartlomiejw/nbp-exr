...
class SettingController extends \WP_REST_Controller {
	...
	public function __construct() {
		$this->prefix    = \NbpExr\Main::PREFIX;
...
//        }
	...
	public function get_settings_structure( $runOptionsCallback = false ) {
		$options = include \NbpExr\Main::$PLUGINDIR . '/config/settings.php';
...
//					}
		...
		$sanitized_value = apply_filters( $this->prefix . '_settings_sanitized',
			$sanitized_value,
			$value,
			$id,
			$details );
